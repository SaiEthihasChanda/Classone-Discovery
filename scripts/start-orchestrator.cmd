...
set RESET_AT=2026-09-21T00:35:00Z
...
goto wait
:run
python backend\src\scripts\rosterOrchestrator.py --institutions %INSTITUTIONS% --reset-at %RESET_AT% --threshold 70 --log "%TEMP%\roster_orchestrator.log" > "%TEMP%\roster_orchestrator.out" 2>&1
